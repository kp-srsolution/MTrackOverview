...
export default function Dashboard() {
    ...
    const [dataSet, setDataSet] = useState([121, 2158]);
    const [weekDataSet, setWeekDataSet] = useState([1364, 14798]);
    const [monthDataSet, setMonthDataSet] = useState([2969, 60598]);
                    ...
                    <div className="production-overview">
                        ...
                        <div className="production-overview-content">
                            ...
                            <div className="production-overview-tile">
                                ...
                                <div className="production-overview-tile-value">151</div>
                                <div className="production-overview-tile-title production-overview-tile-title-small">
                                    <TrendingUpIcon style={{
                                        fontSize: "18px"
                                    }} />
                            ...
                            <div className="production-overview-tile">
                                ...
                                <div className="production-overview-tile-value">621</div>
                            ...
                            <div className="production-overview-tile">
                                ...
                                <div className="production-overview-tile-value">7397</div>
                        ...
                        <div className="production-overview-content">
                            <div className="production-overview-tile graph-tile">
                                ...
                                <LineChart width={windowWidth*0.80 < 630 ? windowWidth*0.80 : 630} height={300} data={
